...
$().ready(function () {
    ...
    // validate check form for input
     $('#input-form').validate({
        ...
        // range: make sure input is between -10 to 10
        ...
        // usually it display right to the input box
    ...
    // Source http://jsfiddle.net/C8X4D/
    ...
    // same with slider1 but change value to
    // responde to the correct input and slider
     $("#slider2").slider({
        range: 20,
        min: -10,
        max: 10,
    ...
    // Run tableCreate and slider when the page first open or refresh with the default values
    tableCreate();
...
// this function use to check if the input passed valid check and create table
...
// this function use to create tab and delete tab when button is click
function TabSaver() {
    ...
    // add tabs function
    // wait for click button click
    // the code is based on the source below
    // Source: http://www.jquerycodesnippets.com/2013/01/add-jquery-tabs-dynamically.html
    // Source: http://jsfiddle.net/EKBqy/
